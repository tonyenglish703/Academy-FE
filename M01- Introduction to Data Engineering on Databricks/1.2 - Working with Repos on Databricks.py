...
# MAGIC 1. Under Settings click "Linked accounts". In Git Integration, 
...
# MAGIC 1. In the upper-right corner of the page, click "Create" and select "Repo."
...
# MAGIC 1. Click "Create" button at the top corner inside the repo folder, and select "Notebook."
