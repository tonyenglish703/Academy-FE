...
# MAGIC %md
# MAGIC
# MAGIC # Demo: The Databricks Platform
# MAGIC
...
# MAGIC ### Pick up where you left off
...
# MAGIC Click "Workspace" in the sidebar menu. The workspace is the way you organize your assets in Databricks. There are five sections: Home, Workspace, Repos, Trash and favourites
# MAGIC ### Home
# MAGIC The "Home" section is a shortcut to your user folder. This folder can also be found by clicking Workspace -> Users -> _your-username_. You can add sub-folders by clicking Create -> Folder, or you can create new assets like Queries, Alerts, Notebooks, MLFlow experiments, and others.
...
# MAGIC
# MAGIC Here's how to navigate and perform common actions within the Workspace:
# MAGIC
...
# MAGIC %md
# MAGIC ### "Kebab" and "Create" Menus
# MAGIC Before leaving this lesson, please note that the "kebab" and "Create" menus provide different functionality depending on the section you are in and the type of file involved. For example, the kebab menu for repos will have a "Git" option where you can commit, pull, and otherwise work with Git. Feel free to add new files and experiment with the kebab and create menus to see how things change.
